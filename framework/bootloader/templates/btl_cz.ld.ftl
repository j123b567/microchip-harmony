 ...
 */
<#if CONFIG_CUSTOM_BOOTLOADER_PROGRAM_SPACE == true>
<#assign resetaddress = "${CONFIG_FLASH_ADDR_START} + ${CONFIG_BOOTLOADER_SIZE}">
<#assign length = "${CONFIG_FLASH_ADDR_SIZE} - ${CONFIG_BOOTLOADER_SIZE}">
<#else>
<#assign resetaddress = "${CONFIG_FLASH_ADDR_START}">
<#assign length = "${CONFIG_BOOTLOADER_SIZE}">
</#if>

MEMORY
{
  FLASH (rx) : ORIGIN = ${resetaddress}, LENGTH = ${length}
