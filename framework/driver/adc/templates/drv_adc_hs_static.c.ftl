...
<@SCAN_SETUP_FUNCTION ANALOG_INPUT_ID=CONFIG_DRV_ADCHS_ANALOG_INPUT_ID_IDX67/>
</#if>
...
<#if CONFIG_DRV_ADCHS_DIGITAL_COMPARATOR_INTERRUPT_EN == true>
    ...
    /* Initialize ADC Digital Comparator Interrupt */
    PLIB_INT_SourceFlagClear(INT_ID_0, INT_SOURCE_ADC_1_DC2);
    PLIB_INT_SourceEnable(INT_ID_0, INT_SOURCE_ADC_1_DC2);
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_ADC1_DC2, ${CONFIG_DRV_ADCHS_INTERRUPT_PRIORITY});
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_ADC1_DC2, ${CONFIG_DRV_ADCHS_INTERRUPT_SUB_PRIORITY});
</#if>
</#if>
...
<#if CONFIG_DRV_ADCHS_DIGITAL_COMPARATOR_INTERRUPT_EN == true>
    ...
    /* Initialize ADC Digital Comparator Interrupt */
    PLIB_INT_SourceFlagClear(INT_ID_0, INT_SOURCE_ADC_1_DC3);
    PLIB_INT_SourceEnable(INT_ID_0, INT_SOURCE_ADC_1_DC3);
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_ADC1_DC3, ${CONFIG_DRV_ADCHS_INTERRUPT_PRIORITY});
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_ADC1_DC3, ${CONFIG_DRV_ADCHS_INTERRUPT_SUB_PRIORITY});
</#if>
</#if>
...
<#if CONFIG_DRV_ADCHS_DIGITAL_COMPARATOR_INTERRUPT_EN == true>
    ...
    /* Initialize ADC Digital Comparator Interrupt */
    PLIB_INT_SourceFlagClear(INT_ID_0, INT_SOURCE_ADC_1_DC4);
    PLIB_INT_SourceEnable(INT_ID_0, INT_SOURCE_ADC_1_DC4);
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_ADC1_DC4, ${CONFIG_DRV_ADCHS_INTERRUPT_PRIORITY});
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_ADC1_DC4, ${CONFIG_DRV_ADCHS_INTERRUPT_SUB_PRIORITY});
</#if>
</#if>
...
<#if CONFIG_DRV_ADCHS_DIGITAL_COMPARATOR_INTERRUPT_EN == true>
    ...
    /* Initialize ADC Digital Comparator Interrupt */
    PLIB_INT_SourceFlagClear(INT_ID_0, INT_SOURCE_ADC_1_DC5);
    PLIB_INT_SourceEnable(INT_ID_0, INT_SOURCE_ADC_1_DC5);
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_ADC1_DC5, ${CONFIG_DRV_ADCHS_INTERRUPT_PRIORITY});
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_ADC1_DC5, ${CONFIG_DRV_ADCHS_INTERRUPT_SUB_PRIORITY});
</#if>
</#if>
...
<#if CONFIG_DRV_ADCHS_DIGITAL_COMPARATOR_INTERRUPT_EN == true>
    ...
    /* Initialize ADC Digital Comparator Interrupt */
    PLIB_INT_SourceFlagClear(INT_ID_0, INT_SOURCE_ADC_1_DC6);
    PLIB_INT_SourceEnable(INT_ID_0, INT_SOURCE_ADC_1_DC6);
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_ADC1_DC6, ${CONFIG_DRV_ADCHS_INTERRUPT_PRIORITY});
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_ADC1_DC6, ${CONFIG_DRV_ADCHS_INTERRUPT_SUB_PRIORITY});
</#if>
</#if>
...
<#if CONFIG_DRV_ADCHS_DIGITAL_FILTER_INTERRUPT == true>
    ...
    /* Initialize ADC Digital Filter Interrupt */
    PLIB_INT_SourceFlagClear(INT_ID_0, INT_SOURCE_ADC_1_DF1);
    PLIB_INT_SourceEnable(INT_ID_0, INT_SOURCE_ADC_1_DF1);
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_ADC1_DF1, ${CONFIG_DRV_ADCHS_INTERRUPT_PRIORITY});
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_ADC1_DF1, ${CONFIG_DRV_ADCHS_INTERRUPT_SUB_PRIORITY});
</#if>	
</#if>
...
<#if CONFIG_DRV_ADCHS_DIGITAL_FILTER_INTERRUPT == true>
    ...
    /* Initialize ADC Digital Filter Interrupt */
    PLIB_INT_SourceFlagClear(INT_ID_0, INT_SOURCE_ADC_1_DF2);
    PLIB_INT_SourceEnable(INT_ID_0, INT_SOURCE_ADC_1_DF2);
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_ADC1_DF2, ${CONFIG_DRV_ADCHS_INTERRUPT_PRIORITY});
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_ADC1_DF2, ${CONFIG_DRV_ADCHS_INTERRUPT_SUB_PRIORITY});
</#if>
</#if>
...
<#if CONFIG_DRV_ADCHS_DIGITAL_FILTER_INTERRUPT == true>
    ...
    /* Initialize ADC Digital Filter Interrupt */
    PLIB_INT_SourceFlagClear(INT_ID_0, INT_SOURCE_ADC_1_DF3);
    PLIB_INT_SourceEnable(INT_ID_0, INT_SOURCE_ADC_1_DF3);
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_ADC1_DF3, ${CONFIG_DRV_ADCHS_INTERRUPT_PRIORITY});
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_ADC1_DF3, ${CONFIG_DRV_ADCHS_INTERRUPT_SUB_PRIORITY});
</#if>
</#if>
...
<#if CONFIG_DRV_ADCHS_DIGITAL_FILTER_INTERRUPT == true>
    ...
    /* Initialize ADC Digital Filter Interrupt */
    PLIB_INT_SourceFlagClear(INT_ID_0, INT_SOURCE_ADC_1_DF4);
    PLIB_INT_SourceEnable(INT_ID_0, INT_SOURCE_ADC_1_DF4);
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_ADC1_DF4, ${CONFIG_DRV_ADCHS_INTERRUPT_PRIORITY});
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_ADC1_DF4, ${CONFIG_DRV_ADCHS_INTERRUPT_SUB_PRIORITY});
</#if>
</#if>
...
<#if CONFIG_DRV_ADCHS_DIGITAL_FILTER_INTERRUPT == true>
    ...
    /* Initialize ADC Digital Filter Interrupt */
    PLIB_INT_SourceFlagClear(INT_ID_0, INT_SOURCE_ADC_1_DF5);
    PLIB_INT_SourceEnable(INT_ID_0, INT_SOURCE_ADC_1_DF5);
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_ADC1_DF5, ${CONFIG_DRV_ADCHS_INTERRUPT_PRIORITY});
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_ADC1_DF5, ${CONFIG_DRV_ADCHS_INTERRUPT_SUB_PRIORITY});
</#if>
</#if>
...
<#if CONFIG_DRV_ADCHS_DIGITAL_FILTER_INTERRUPT == true>
    ...
    /* Initialize ADC Digital Filter Interrupt */
    PLIB_INT_SourceFlagClear(INT_ID_0, INT_SOURCE_ADC_1_DF6);
    PLIB_INT_SourceEnable(INT_ID_0, INT_SOURCE_ADC_1_DF6);
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_ADC1_DF6, ${CONFIG_DRV_ADCHS_INTERRUPT_PRIORITY});
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_ADC1_DF6, ${CONFIG_DRV_ADCHS_INTERRUPT_SUB_PRIORITY});
</#if>
</#if>
...
<#if CONFIG_DRV_ADCHS_INTERRUPT_MODE == true>
<#if CONFIG_DRV_ADCHS_DIGITAL_FILTER_INTERRUPT == false
        && CONFIG_DRV_ADCHS_DIGITAL_COMPARATOR_INTERRUPT_EN == false>
