...
#ifndef _DRV_CAN_STATIC_PIC32C_H_
#define _DRV_CAN_STATIC_PIC32C_H_
...
bool DRV_CAN${DRV_INSTANCE}_ChannelMessageTransmit(CAN_CHANNEL channelNum,
        int address, uint8_t DLC, uint8_t* message);
bool DRV_CAN${DRV_INSTANCE}_ChannelMessageReceive(CAN_CHANNEL channelNum,
        int address, uint8_t DLC, uint8_t* message);
</#macro>
...
#endif // #ifndef _DRV_CAN_STATIC_PIC32C_H_
