...
<#if CONFIG_DRV_AFEC_INST_IDX0 == true>
    sysObj.drvAfec0 = DRV_AFEC_Initialize(DRV_AFEC_INDEX_0, (SYS_MODULE_INIT *)&drvAfec0InitData);
</#if>

<#if CONFIG_DRV_AFEC_INST_IDX1 == true>
    sysObj.drvAfec1 = DRV_AFEC_Initialize(DRV_AFEC_INDEX_1, (SYS_MODULE_INIT *)&drvAfec1InitData);
</#if>
