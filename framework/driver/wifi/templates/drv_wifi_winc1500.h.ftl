...
<#elseif CONFIG_BSP_PIC32CZ_CA70_XULT!false>
#define WDRV_BOARD_TYPE WDRV_BD_TYPE_CA70_XULT
<#else>
...
<#if CONFIG_DSTBDPIC32CZ!false>
#define WDRV_CHIP_EN_PORT_CHANNEL   PORTS_CHANNEL_${CONFIG_WINC1500_CHIP_EN_PORT_CHANNEL}
#define WDRV_CHIP_EN_BIT_POS        ${CONFIG_WINC1500_CHIP_EN_BIT_POS}

#define WDRV_IRQN_PORT_CHANNEL      PORTS_CHANNEL_${CONFIG_WINC1500_IRQ_PORT_CHANNEL}
#define WDRV_IRQN_BIT_POS           ${CONFIG_WINC1500_IRQ_BIT_POS}

#define WDRV_RESET_N_PORT_CHANNEL   PORTS_CHANNEL_${CONFIG_WINC1500_RESET_PORT_CHANNEL}
#define WDRV_RESET_N_BIT_POS        ${CONFIG_WINC1500_RESET_BIT_POS}

#define WDRV_SPI_SSN_PORT_CHANNEL   PORTS_CHANNEL_${CONFIG_WINC1500_SPI_SS_PORT_CHANNEL}
