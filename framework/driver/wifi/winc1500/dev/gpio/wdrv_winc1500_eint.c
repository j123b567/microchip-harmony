...
static void _WDRV_WINC1500_ISR_PinCallback(uintptr_t context)
{
    WDRV_WINC1500_ISR();
}
#endif
...
#if defined(__PIC32C__)
    /* Get the status of interrupt, this will clear interrupt flags */
    SYS_PORTS_InterruptStatusGet(PORTS_ID_0, PORTS_CHANNEL_D);

    SYS_PORTS_PinCallbackRegister(WDRV_IRQN_PORT_CHANNEL, WDRV_IRQN_BIT_POS, _WDRV_WINC1500_ISR_PinCallback, (uintptr_t)NULL);
#endif
