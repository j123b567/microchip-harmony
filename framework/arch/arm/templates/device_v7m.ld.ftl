...
MEMORY
{
  FLASH (rx) : ORIGIN = ${CONFIG_FLASH_ADDR_START}, LENGTH = ${CONFIG_FLASH_ADDR_SIZE}
  RAM (rwx) : ORIGIN = ${CONFIG_SRAM_ADDR_START}, LENGTH = ${CONFIG_SRAM_ADDR_SIZE}
}

/* The stack size used by the application. NOTE: you need to adjust according to your application. */
/*STACK_SIZE = DEFINED(STACK_SIZE) ? STACK_SIZE : 0x0400;*/
STACK_SIZE = ${CONFIG_XC32_STACK_ARM};
...
HEAP_SIZE = ${CONFIG_XC32_HEAP_ARM};
...
ENTRY(${CONFIG_PROJECT_RESET_HANDLER_CUSTOM_NAME})
<#else>
ENTRY(Reset_Handler)
</#if>
...
GROUP(
  libm.a
  libgcc.a
<#if CONFIG_XC32_NEWLIB == true>
  libc.a
  libg.a
  libstdc++.a
  libsupc++.a
</#if>
<#if CONFIG_XC32_NEWLIB_NANO == true>
  libc_nano.a
  libg_nano.a
  libstdc++_nano.a
  libsupc++_nano.a
</#if>
<#if CONFIG_XC32_SYSCALLS_NOSYS == true>
  libnosys.a
</#if>
)
