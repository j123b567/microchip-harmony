/*******************************************************************************
  Speex Decoder Library Implementation (Deprecated)
  ...
  Summary:
   Contains the functional implementation of speex decoder interface.
   This file is deprecated, use speex_dec.c instead

  Description:
   This file contains the functional implementation of speex decoder interface.
 *******************************************************************************/
