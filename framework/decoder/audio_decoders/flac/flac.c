/*******************************************************************************
 FLAC Decoder Library Interface File (Deprecated)
  ...
  Summary:
	...
	This file is deprecated, use flac_dec.c instead.
    
  Description:
    FLAC decoder interface function implementations, it is not library source code of flac,
