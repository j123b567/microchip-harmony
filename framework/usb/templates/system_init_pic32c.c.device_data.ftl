<#--
/*******************************************************************************
  System Initialization Device File

  File Name:
    system_init.c.device_data.ftl
 ...
 ***********************************************/
USB_MSD_CBW msdCBW${usbDeviceMSDIndex} __attribute__((aligned(16)));
USB_MSD_CSW msdCSW${usbDeviceMSDIndex} __attribute__((aligned(16)));
 ...
 *******************************************/
USB_DEVICE_MSD_MEDIA_INIT_DATA __attribute__((aligned(16))) msdMediaInit${usbDeviceMSDIndex}[${CONFIG_USB_DEVICE_FUNCTION_1_MSD_LUN_IDX0?number}] =
{
    <#-- LUN0 -->
...
const USB_DEVICE_HID_INIT hidInit${usbDeviceHIDIndexInit} =
{
    ...
    .hidReportDescriptor = (void *)(&hid_rpt${usbDeviceHIDIndexInit}),
...
const USB_DEVICE_FUNCTION_REGISTRATION_TABLE funcRegistrationTable[${CONFIG_USB_DEVICE_NUMBER_REGISTRED_FUNCTION_DRIVER_IDX0}] =
{
    ...
    { 
        ...
        .speed = ${CONFIG_USB_DEVICE_FUNCTION_1_SPEED_HSV1_NORMAL_MODE_IDX0},    /* Function Speed */ 
        <#else >
        .speed = ${CONFIG_USB_DEVICE_FUNCTION_1_SPEED_HSV1_LOWPOWER_MODE_IDX0},    /* Function Speed */ 
        </#if>
        <#if CONFIG_USB_DEVICE_FUNCTION_1_DEVICE_CLASS_CDC_IDX0 == true>
    ...
    /* Function 2 */
    {
        ...
        <#if CONFIG_USB_DEVICE_FUNCTION_2_SPEED_HSV1_NORMAL_IDX0>
        .speed = ${CONFIG_USB_DEVICE_FUNCTION_2_SPEED_HSV1_NORMAL_MODE_IDX0},    /* Function Speed */ 
        <#else >
        .speed = ${CONFIG_USB_DEVICE_FUNCTION_2_SPEED_HSV1_LOWPOWER_MODE_IDX0},    /* Function Speed */ 
        </#if>
        <#if CONFIG_USB_DEVICE_FUNCTION_2_DEVICE_CLASS_CDC_IDX0 == true>
        .numberOfInterfaces = ${usbDeviceCdcNumberOfInterfaces},    /* Number of interfaces */
    ...
    /* Function 3 */ 
    {
        ...
        <#if CONFIG_USB_DEVICE_FUNCTION_3_SPEED_HSV1_NORMAL_IDX0>
        .speed = ${CONFIG_USB_DEVICE_FUNCTION_3_SPEED_HSV1_NORMAL_MODE_IDX0},    /* Function Speed */ 
        <#else >
        .speed = ${CONFIG_USB_DEVICE_FUNCTION_3_SPEED_HSV1_LOWPOWER_MODE_IDX0},    /* Function Speed */ 
        </#if>
        <#if CONFIG_USB_DEVICE_FUNCTION_3_DEVICE_CLASS_CDC_IDX0 == true>
        .numberOfInterfaces = ${usbDeviceCdcNumberOfInterfaces},    /* Number of interfaces */
    ...
    /* Function 4 */ 
    {
        ...
        <#if CONFIG_USB_DEVICE_FUNCTION_4_SPEED_HSV1_NORMAL_IDX0>
        .speed = ${CONFIG_USB_DEVICE_FUNCTION_4_SPEED_HSV1_NORMAL_MODE_IDX0},    /* Function Speed */ 
        <#else >
        .speed = ${CONFIG_USB_DEVICE_FUNCTION_4_SPEED_HSV1_LOWPOWER_MODE_IDX0},    /* Function Speed */ 
        </#if>
        <#if CONFIG_USB_DEVICE_FUNCTION_4_DEVICE_CLASS_CDC_IDX0 == true>
        .numberOfInterfaces = ${usbDeviceCdcNumberOfInterfaces},    /* Number of interfaces */
    ...
    /* Function 5 */ 
    {
        ...
        <#if CONFIG_USB_DEVICE_FUNCTION_5_SPEED_HSV1_NORMAL_IDX0>
        .speed = ${CONFIG_USB_DEVICE_FUNCTION_5_SPEED_HSV1_NORMAL_MODE_IDX0},    /* Function Speed */ 
        <#else >
        .speed = ${CONFIG_USB_DEVICE_FUNCTION_5_SPEED_HSV1_LOWPOWER_MODE_IDX0},    /* Function Speed */ 
        </#if>
        <#if CONFIG_USB_DEVICE_FUNCTION_5_DEVICE_CLASS_CDC_IDX0 == true>
        .numberOfInterfaces = ${usbDeviceCdcNumberOfInterfaces},    /* Number of interfaces */
    ...
    /* Function 6 */ 
    {
        ...
        <#if CONFIG_USB_DEVICE_FUNCTION_6_SPEED_HSV1_NORMAL_IDX0>
        .speed = ${CONFIG_USB_DEVICE_FUNCTION_6_SPEED_HSV1_NORMAL_MODE_IDX0},    /* Function Speed */ 
        <#else >
        .speed = ${CONFIG_USB_DEVICE_FUNCTION_6_SPEED_HSV1_LOWPOWER_MODE_IDX0},    /* Function Speed */ 
        </#if>
        <#if CONFIG_USB_DEVICE_FUNCTION_6_DEVICE_CLASS_CDC_IDX0 == true>
        .numberOfInterfaces = ${usbDeviceCdcNumberOfInterfaces},    /* Number of interfaces */
    ...
    /* Function 7 */ 
    {
        ...
        <#if CONFIG_USB_DEVICE_FUNCTION_7_SPEED_HSV1_NORMAL_IDX0>
        .speed = ${CONFIG_USB_DEVICE_FUNCTION_7_SPEED_HSV1_NORMAL_MODE_IDX0},    /* Function Speed */ 
        <#else >
        .speed = ${CONFIG_USB_DEVICE_FUNCTION_7_SPEED_HSV1_LOWPOWER_MODE_IDX0},    /* Function Speed */ 
        </#if>
        <#if CONFIG_USB_DEVICE_FUNCTION_7_DEVICE_CLASS_CDC_IDX0 == true>
        .numberOfInterfaces = ${usbDeviceCdcNumberOfInterfaces},    /* Number of interfaces */
    ...
    /* Function 8 */ 
    {
        ...
        <#if CONFIG_USB_DEVICE_FUNCTION_8_SPEED_HSV1_NORMAL_IDX0>
        .speed = ${CONFIG_USB_DEVICE_FUNCTION_8_SPEED_HSV1_NORMAL_MODE_IDX0},    /* Function Speed */ 
        <#else >
        .speed = ${CONFIG_USB_DEVICE_FUNCTION_8_SPEED_HSV1_LOWPOWER_MODE_IDX0},    /* Function Speed */ 
        </#if>
        <#if CONFIG_USB_DEVICE_FUNCTION_8_DEVICE_CLASS_CDC_IDX0 == true>
        .numberOfInterfaces = ${usbDeviceCdcNumberOfInterfaces},    /* Number of interfaces */
    ...
    /* Function 9 */ 
    {
        ...
        <#if CONFIG_USB_DEVICE_FUNCTION_9_SPEED_HSV1_NORMAL_IDX0>
        .speed = ${CONFIG_USB_DEVICE_FUNCTION_9_SPEED_HSV1_NORMAL_MODE_IDX0},    /* Function Speed */ 
        <#else >
        .speed = ${CONFIG_USB_DEVICE_FUNCTION_9_SPEED_HSV1_LOWPOWER_MODE_IDX0},    /* Function Speed */ 
        </#if>
        <#if CONFIG_USB_DEVICE_FUNCTION_9_DEVICE_CLASS_CDC_IDX0 == true>
        .numberOfInterfaces = ${usbDeviceCdcNumberOfInterfaces},    /* Number of interfaces */
    ...
    /* Function 10 */ 
    {
        ...
        <#if CONFIG_USB_DEVICE_FUNCTION_10_SPEED_HSV1_NORMAL_IDX0>
        .speed = ${CONFIG_USB_DEVICE_FUNCTION_10_SPEED_HSV1_NORMAL_MODE_IDX0},    /* Function Speed */ 
        <#else >
        .speed = ${CONFIG_USB_DEVICE_FUNCTION_10_SPEED_HSV1_LOWPOWER_MODE_IDX0},    /* Function Speed */ 
        </#if>
        <#if CONFIG_USB_DEVICE_FUNCTION_10_DEVICE_CLASS_CDC_IDX0 == true>
        .numberOfInterfaces = ${usbDeviceCdcNumberOfInterfaces},    /* Number of interfaces */
...
<#if CONFIG_USB_DEVICE_SPEED_HSV1_IDX0 == "USB_SPEED_NORMAL">
/*******************************************
...
const uint8_t highSpeedConfigurationDescriptor[]=
{
    ...
    ${usbDeviceConfigOneDescriptorSize % 256},${usbDeviceConfigOneDescriptorSizeUpperByte?floor},                                               //(${usbDeviceConfigOneDescriptorSize?number} Bytes)Size of the Config descriptor
...
<#if CONFIG_USB_DEVICE_NUMBER_REGISTRED_FUNCTION_DRIVER_IDX0?has_content>
    ...
    /* USB Device Speed Configuration */
<#if CONFIG_USB_DEVICE_FUNCTION_1_SPEED_HSV1_NORMAL_IDX0>
    .deviceSpeed = ${CONFIG_USB_DEVICE_FUNCTION_1_SPEED_HSV1_NORMAL_MODE_IDX0},
    
<#else >
    .deviceSpeed = ${CONFIG_USB_DEVICE_FUNCTION_1_SPEED_HSV1_LOWPOWER_MODE_IDX0},
