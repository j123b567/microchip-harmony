...
ifblock USB_DEVICE_INST_IDX${INSTANCE}
	...
	config USB_DEVICE_SPEED_FS_IDX${INSTANCE}
        string
        depends on USE_USB_STACK && DRV_USB_DEVICE_SUPPORT && (PIC32MX || PIC32MK || PIC32WK)
	...
	config USB_DEVICE_SPEED_HSV1_IDX${INSTANCE}
        ...
        depends on USE_USB_STACK && DRV_USB_DEVICE_SUPPORT && DSTBDPIC32CZ
...
config USB_DEVICE_ENDPOINT_QUEUE_SIZE_WRITE_IDX${INSTANCE}
	...
	config DRV_USB_PERIPHERAL_ID_IDX${INSTANCE}
		...
		default "USB_ID_1" if (PIC32MX || PIC32MK || PIC32WK)
		default "_USBHS_BASE_ADDRESS" if DSTBDPIC32CZ
    ...
    config DRV_USB_INTERRUPT_SOURCE_IDX${INSTANCE}
        ...
        depends on USE_USB_STACK && DRV_USB_DEVICE_SUPPORT && DRV_USB_INTERRUPT_MODE
        range INT_SOURCE
        default "INT_SOURCE_USB_1" if (PIC32MX || PIC32MK || PIC32WK || PIC32MZ)
        default "USBHS_IRQn" if DSTBDPIC32CZ
        ---help---
    ...
    config DRV_USB_INTERRUPT_PRIORITY_IDX${INSTANCE}
        ...
        default "INT_PRIORITY_LEVEL4" if (PIC32MX || PIC32MK || PIC32WK || PIC32MZ)
	default "INT_PRIORITY_LEVEL5" if DSTBDPIC32CZ
        ---help---
    ...
    string
    depends on USE_USB_STACK && DRV_USB_DEVICE_SUPPORT && DRV_USB_INTERRUPT_MODE
    default "_USB_1_VECTOR" if DRV_USB_INTERRUPT_VECTOR_IDX${INSTANCE} = "INT_VECTOR_USB1" && (PIC32MX || PIC32MK)
