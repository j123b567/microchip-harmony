...
<#if (CONFIG_DSTBDPIC32CZ == true)>
const TCPIP_MODULE_MAC_PIC32C_CONFIG tcpipMACPIC32INTInitData =
{ 
...
<#if (CONFIG_TCPIP_STACK_NETWORK_CONFIG_IDX0 && CONFIG_TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX0 == "PIC32CINT") || (CONFIG_TCPIP_STACK_NETWORK_CONFIG_IDX1 && CONFIG_TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX1 == "PIC32CINT")>
    {TCPIP_MODULE_MAC_PIC32C,     &tcpipMACPIC32INTInitData},     // TCPIP_MODULE_MAC_PIC32C
</#if>
<#if CONFIG_USE_DRV_WIFI == true>
 <#if CONFIG_DRV_WIFI_DEVICE == "MRF24WN">
 ...
 <#elseif CONFIG_DRV_WIFI_DEVICE == "WINC1500">
  <#if (CONFIG_TCPIP_STACK_NETWORK_CONFIG_IDX0 && CONFIG_TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX0 == "WINC1500") || (CONFIG_TCPIP_STACK_NETWORK_CONFIG_IDX1 && CONFIG_TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX1 == "WINC1500")>
    {TCPIP_MODULE_MAC_WINC1500,     &macWINC1500ConfigData},        // TCPIP_MODULE_MAC_WINC1500
  </#if>
 <#elseif CONFIG_DRV_WIFI_DEVICE == "WILC1000">
  <#if (CONFIG_TCPIP_STACK_NETWORK_CONFIG_IDX0 && CONFIG_TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX0 == "WILC1000") || (CONFIG_TCPIP_STACK_NETWORK_CONFIG_IDX1 && CONFIG_TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX1 == "WILC1000")>
