...
//DOM-IGNORE-BEGIN
// Make interface compliant with Harmony, don't use SFR bit bangs
#define HARMONY_COMPLIANT

#if defined( HARMONY_COMPLIANT )
  #include "./peripheral/pmp/plib_pmp.h"
#endif//defined( HARMONY_COMPLIANT )
...
#if !defined( HARMONY_COMPLIANT )
  #define RESETbar_PORT_BIT  PORTDbits.RD2
  #define RESETbar_TRIS_BIT  TRISDbits.TRISD2

  #define D_CBar_PORT_BIT    PORTDbits.RD1
  #define D_CBar_TRIS_BIT    TRISDbits.TRISD1

  #define CSbar_PORT_BIT     PORTGbits.RG15
  #define CSbar_TRIS_BIT     TRISGbits.TRISG15

  #define RDbar_PORT_BIT     PORTDbits.RD5
  #define RDbar_TRIS_BIT     TRISDbits.TRISD5

  #define WRbar_PORT_BIT     PORTCbits.RC8
  #define WRbar_TRIS_BIT     TRISCbits.TRISC8

  #define BACKLIGHT_PORT_BIT PORTGbits.RG10
  #define BACKLIGHT_TRIS_BIT TRISGbits.TRISG10
#endif
